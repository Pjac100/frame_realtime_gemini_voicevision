...
// --- ObjectBox ---
// This import will be generated by the build_runner in a later step.
...
Future<void> main() async {
  // This is required so ObjectBox can be initialized before runApp().
  WidgetsFlutterBinding.ensureInitialized();

  // --- ObjectBox Initialization ---
  // The openStore() function is created by the code generator.
  store = await openStore();
  // --- End ObjectBox Initialization ---
...
class MainAppState extends State<MainApp> with SimpleFrameAppState {
  ...
  MainAppState() {
    ...
    // We will refactor how the service is initialized later.
  ...
  Future<void> _asyncInit() async {
    ...
    // The old service initialization will be replaced.
    // For now, we leave this as is and will refactor the service itself.
