  ...
  obx_int.ModelEntity(
    ...
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 7866203739689354284),
        name: 'id',
        type: 6,
        flags: 1,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 4656333213835919172),
        name: 'textContent',
        type: 9,
        flags: 0,
      ),
...
class Document_ {
  ...
  /// See [Document.textContent].
  static final textContent = obx.QueryStringProperty<Document>(
